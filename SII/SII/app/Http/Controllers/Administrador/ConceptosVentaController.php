...
class ConceptosVentaController extends Controller
{
   ...
   public function index(Request $request){
    ...
    public function create(){
    	...
    	return view("admin.cobranza.conceptos.create", ["alumnos" => $alumnos, "plan" => $plan,  "cajas" => $cajas]);
    }
    ...
    public function store(Request $request){
        ...
        $Ciclo = Ciclo::find(\Session::get('ciclos')->idCiclo);
        ...
        try{
            ...
            $venta->idCiclo=\Session::get('ciclos')->idCiclo;
            ...
            $idCiclo = \Session::get('ciclos')->idCiclo;
        ...
        return "<script>var confirmar = confirm('Hemos Detectado que no se ha Seleccionado un Ciclo para Trabajar, Por favor Seleccione uno para Continuar');if(confirmar == true){location.href ='../concepto/create';}</script>";
    }
    }
