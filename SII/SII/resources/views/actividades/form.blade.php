...
<div class="form-group {{ $errors->has('idCatalogoEvento') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
         <input class="form-control" name="idCatalogoEvento" type="number" id="idCatalogoEvento" value="{{ $actividade->idCatalogoEvento or ''}}" >
...
<div class="form-group {{ $errors->has('idCiclo') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
         <input class="form-control" name="idCiclo" type="number" id="idCiclo" value="{{ $actividade->idCiclo or ''}}" >
...
<div class="form-group {{ $errors->has('idEvento') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
         <input class="form-control" name="idEvento" type="number" id="idEvento" value="{{ $actividade->idEvento or ''}}" >
...
<div class="form-group {{ $errors->has('id_alumno') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
         <input class="form-control" name="id_alumno" type="number" id="id_alumno" value="{{ $actividade->id_alumno or ''}}" >
...
<div class="form-group {{ $errors->has('descripcion') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
         <input class="form-control" name="descripcion" type="text" id="descripcion" value="{{ $actividade->descripcion or ''}}" >
