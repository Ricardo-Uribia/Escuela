                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <a href="" data-target="#modal-evento-titulacion" data-toggle="modal"><button class="btn" style=" width:150px;height:50px; "><span class="fa fa-file"></span> Agregar Estadia</button></a>
                                @include('utp.titulacion.modalEvento')
                        </div>
                                ...
                                <div class="form-group">
                                    <table class="table table-striped table-bordered table-condensed table-hover" style="width: 100%; height: 80%;">
                                        ...
                                        @foreach($empresaAlumno as $empreAlum)
                                            <tr>
                                                <td>{{$empreAlum->pivot->id}}</td> 
                                                <td>{{$empreAlum->name}}</td>
                                                <td>{{$empreAlum->pivot->fechaIncio}} a {{$empreAlum->pivot->fechaConclusion}}</td>
                                                <td>{{$empreAlum->pivot->supervisorNombre}}</td>
                                                <td><a href="" data-target="#modal-servico-social-{{$empreAlum->pivot->id}}" data-toggle="modal"><button  class="btn" style=" width:150px;"><span class="fa fa-edit"></span> Editar Estadia</button></a> @include('utp.titulacion.editServicioSocial')
                                                <a href="{{url('/')}}/utp/borrar-servicio-social/{{$empreAlum->pivot->empresa_id}}/{{$empreAlum->id}}"><button  class="btn" style=" width:150px;"><span class="fa fa-edit"></span> Eliminar<button></a></td>
