                ...
                <div role="tabpanel" class="tab-pane" id="academicos">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cargo" required  placeholder="Cargo..." class="form-control" value="{{old('cargo')}}" >
                                 </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group">
                                    <label for="contrato">Contrato</label>
                                    <input type="text" name="contrato" required  placeholder="Contrato..." class="form-control" value="{{old('contrato')}}" >
                                </div>
                            </div>
