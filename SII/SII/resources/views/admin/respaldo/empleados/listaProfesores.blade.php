...
<div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
        <h3>Listado de Empleados <a href="{{url('/crear/Empleado')}}"><br><br><button class="btn btn-success">Nuevo Empleado</button>
        </a><a href="{{url('/crear/profesor')}}"><button class="btn btn-success">Nuevo Profesor</button></a></h3>
