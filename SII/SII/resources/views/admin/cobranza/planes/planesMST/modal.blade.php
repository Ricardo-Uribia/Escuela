<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-delete-{{$pl->idPlanesPagoMST}}">
	<form action="{{url('/')}}/utp/planesMST-destroy-{{$pl->idPlanesPagoMST}}" method="POST">
	  {{Form::token()}}
