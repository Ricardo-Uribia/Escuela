...
<a href="{{url('/')}}/utp/venta/concepto"><button style="width: 25%" class="btn btn-warning"><i class="fa fa-th"></i> Concepto Esporadico</button></a>
  <div class="row">
  ...
  <ul class="dropdown-menu" role="menu">
    <!--<li><a href="{{url('/')}}/utp/concepto/create"><button class="btn btn-info" style=""><i class="fa fa-money fa-fw"></i>C_Conceptos</button></a></li>-->

    <li><a href="{{url('/')}}/utp/venta/plan/create"><button class="btn btn-info" style=""><i class="fa fa-money fa-fw"></i>C_Planes</button></a> </li>
...
$(document).ready(function(){
      ...
      function agregar() {
            ...
            if(consepto!="" &&  precio!="" && impuesto!="" && cantidad!="")
            {
                  ...
                  subtotal[cont] = precioCantidad;   //Unicamente se refleja el precio por cantidad
                  precioIva[cont] = iva;            //Unicamente se refleja el iva

                  total1=precioIva[cont]+subtotal[cont];  //total de  l aventa
