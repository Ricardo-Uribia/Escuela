...
<script type="text/javascript">
    $(document).ready(function(){
     ...
     function cargarpais(){
                $('#estado_id28 option:eq(<?= $emple->estado_id; ?>)').prop('selected', true);   
    
    }

cargarpais();
     var valorEstado = $("#estado_id28").val();

    $.get("../../towns/" + valorEstado + "", function(response, state){
        //console.log(response);
        $("#town2").empty();
        for ( i = 0; i<response.length; i++) {
            $("#town2").append("<option value='"+ response[i].id +"' > "  + response[i].nombre + "</option>");

        }
    });
   
    });
$("#estado_id28").change(function (event) {
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <select name="estadoActual28" id="estado_id28" class="form-control selectpicker" data-live-search="true">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        {!!Form::select('town28', ['placeholder' => 'Selecciona'], null, ['id' => 'town28', 'class' => 'form-control', 'name' => 'municipioActual'])!!}
                                    </div>
                                </div>
                                @else
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <label for="estado_id">Estado</label>
                                        <select name="estadoActual" id="estado_id28" class="form-control selectpicker" data-live-search="true">
                                            <option value="">Estado</option>
                                                @foreach($estados as $u)
                                                    <option  value="{{$u['id']}}">
                                                        {{$u['NOMBRE']}}
