                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading ">
                            <center><h4>Seguimiento a Estadia-Egresado-TSU, Egresado-IT, Egresado-LIC</h4></center> 
                        </div>
                    </div>
            </div> 
        </div>
    ...
    <div class="col-md-12 contenedor-datos">
        <div role="tabpanel">
          <ul class="nav nav-pills" role="tablist">
            ...
            <li role="presentation"><a href="#documentos" aria-controls="documentos" data-toggle="tab" role="tab"><b><u>DOCUMENTOS</u></b></a></li>
            ...
            <center>
               ...
               <br>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="" name="folioAlumn" value="{{ $alum->Folio }}" readonly>
                    </div><br>
                        ...
                        <input type="text" class="form-control" placeholder="" name="Matricula" value="{{ $alum->Matricula }}">
                              ...
                              <div class="input-group">
                                ...
                                <select class="form-control" name="status" readonly>
                                    ...
                                    @if($alum->Status=='A')
                                    <option value="A" selected>Aspirante</option>
                                     @elseif($alum->Status=='N')
                                    <option value="N" selected>Nuevo ingreso</option>
                                     @elseif($alum->Status=='R')
                                    <option value="R">Regular</option>
                                     @elseif($alum->Status=='RI')
                                    <option value="RI">Reingreso</option>
                                     @elseif($alum->Status=='C')
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control" name="nivel" value="" readonly>

                                    <option value="">Seleciona</option>
                                    @if($alum->Nivel=='TSU')
                                    <option value="TSU" selected>Técnico Superior Universitario</option>
                                    @elseif($alum->Nivel=='Ing')
                                    <option value="Ing" selected>Ingeniería Técnica</option>
                                    @endif
                        </select>  
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control" name="carreraAlumn" value="" readonly>
                                    <option value="">Selecciona la carrera a la que deseas registrarte</option>
                                    @if($alum->Carrera=='1')
                                     <option value="1" selected>Administración Área Formulación y Evaluación de Proyectos</option>
                                    @elseif($alum->Carrera=='2')
                                     <option value="2" selected>Gastronomía</option>
                                    @elseif($alum->Carrera=='3')
                                    <option value="3" selected>Procesos Alimentarios</option>
                                    @elseif($alum->Carrera=='4')
                                     <option value="4" selected>Tecnologías de la Información y Comunicación Área Sistemas Informáticos</option>
                                    @elseif($alum->Carrera=='5')
                                     <option value="5" selected>Turismo Área Desarrollo de Productos Alternativos</option>
                                    @elseif($alum->Carrera=='6')
                                     <option value="6" selected>Evaluación Socioeconómica de Proyectos de Inversión</option>
                                    @elseif($alum->Carrera=='7')
                                     <option value="7" selected>Comercialización de Productos Gastronómicos</option>
                                    @elseif($alum->Carrera=='8')
                                     <option value="8" selected>Seguridad e Inocuidad Alimentaria</option>
                                    @elseif($alum->Carrera=='9')
                                     <option value="9" selected>Desarrollo de Software para Aplicaciones Web</option>
                                    @elseif($alum->Carrera=='10')
                                     <option value="10" selected>Desarrollo y Promoción del Turismo Sustentable</option>
                                    @endif
                        </select>  
                    </div><br>
               ...
               <br>
                    ...
                    <div class="input-group">
                     ...
                     <div class="input-group">
                                ...
                                <select class="form-control" name="genero" value="" readonly>
                                    <option value="">Seleciona</option>
                                    @if($alum->Genero=='M')
                               ...
                               <select class="form-control" name="civilAlumn" value="" readonly>
                                    <option value="">Seleciona</option>
                                     @if($alum->Estado_Civil=='S')
                                    <option value="S" selected>Soltero</option>
                                    @elseif($alum->Estado_Civil=='C')
                                    <option value="C" selected>Casado</option>
                                    @elseif($alum->Estado_Civil=='U')
                                    <option value="U" selected>Unión Libre</option>
                                    @elseif($alum->Estado_Civil=='D')
                                    <option value="D" selected>Divorsiado</option>
                                    @elseif($alum->Estado_Civil=='V')
                    ...
                    <div class="input-group">
                     ...
                     <div class="input-group">
                      ...
                      <div class="input-group">
                                ...
                                <select class="form-control" name="parentescoAlumn" value="" readonly>
                                    <option value="">Seleciona</option>
                                    @if($alum->Parentesco_Autorizada=='M')
                                    <option value="M" selected>Madre</option>
                                    @elseif($alum->Parentesco_Autorizada=='P')
                                    <option value="P" selected>Padre</option>
                                    @elseif($alum->Parentesco_Autorizada=='H')
                                    <option value="H">Hermano(a)</option>
                                    @elseif($alum->Parentesco_Autorizada=='R')
...
<div>
    ...
    <dl>
        ...
        @if($alum->Misma_Autorizada=='a')
            ...
            @elseif($alum->Misma_Autorizada=='b')
            <input type="radio" name="tipo_attach" onclick="toggle(this)" value="a"> Si<br>
            <input type="radio" name="tipo_attach" onclick="toggle(this)" value="b" checked> No<br>
            @endif
        </dd>
    </dl>
</fieldset>
...
<center><p>Ingrese los datos de la persona de contacto</p></center>
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="" name="nombreContact" value="{{$alum->Contacto}}" readonly>
                    </div><br>

                     <div class="input-group">
                                <span class="input-group-addon">Parentesco</span>
                                <select class="form-control" name="parentescoContact" value="" readonly>
                                    <option value="">Seleciona</option>
                                    @if($alum->Parentesco_Contacto=='M')
                                    <option value="M" selected>Madre</option>
                                     @elseif($alum->Contacto=='P')
                                    <option value="P" selected>Padre</option>
                                    @elseif($alum->Contacto=='H')
                                    <option value="H" selected>Hermano(a)</option>
                                    @elseif($alum->Contacto=='R')
                             ...
                             <div class="input-group">
                        <span class="input-group-addon">Teléfono</span>
                        <input type="text" class="form-control" placeholder="" name="telcontact" value="{{$alum->Tel_Contacto}}" readonly>
                    </div><br>
</div>
                    ...
                    <div class="col-md-9">
                        <div id="sidebar">
                           ...
                           <div class="input-group">
                                ...
                                <select class="form-control" name="origenAlumn" value="" readonly>
                                    <option value="">Seleciona</option>
                                    @if($alum->Origen_Indigena=='S')
                                    <option value="S" selected>Si</option>
                                    @elseif($alum->Origen_Indigena=='N')
                                    <option value="N" selected>No</option>
                                    @endif
                                </select>  

                                <span class="input-group-addon">Lengua Indígena</span>
                                <select class="form-control" name="lengAlumn" value="" readonly>
                                    <option value="">Seleciona</option>
                                    @if($alum->Lengua_Indigena=='S')
                                    <option value="S" selected>Si</option>
                                    @elseif($alum->Lengua_Indigena=='N')
                                    <option value="N" selected>No</option>
                                    @endif
                                </select> 
                            </div><br>
...
<div class="form-group">
           ...
           <a href="editAlumno.blade.php" class="btn btn-info" role="button">Actualizar</a></a>
          ...
          <ul class="nav nav-pills" role="tablist">
            <!--li role="presentation" class="active"><a href="#ingreso" aria-controls="ingreso" data-toggle="tab" role="tab">Aspirante</a></li-->
             ...
             <li role="presentation"><a href="#egresadoIt" aria-controls="egresadoIt" data-toggle="tab" role="tab">Egresado IT</a></li>
              <li role="presentation"><a href="#onceCuatri" aria-controls="onceCuatri" data-toggle="tab" role="tab">C11</a></li>
            <li role="presentation"><a href="#egresadoLic" aria-controls="egresadoLic" data-toggle="tab" role="tab">Egresado LIC</a></li>
...
<!--Ricardo///////////////////////////////////////////////-->
 ...
 <div class="contenedor-modal">
 <a href="" data-target="#miModal28" data-toggle="modal"><button type="button" class="btn btn-primary btn-lg btn-block">Carta de presentacion</button></a>
</div>
...
<div class="contenedor-modal">
 <a href="" data-target="#miModal28" data-toggle="modal"><button type="button" class="btn btn-primary btn-lg btn-block">Carta de aceptacion</button></a>
</div>
...
<div class="contenedor-modal">
 <a href="" data-target="#miModal28" data-toggle="modal"><button type="button" class="btn btn-primary btn-lg btn-block">Carta compromiso</button></a>
</div>
...
<!--div class="contenedor-modal">
 <a href="" data-target="#miModal28" data-toggle="modal"><button type="button" class="btn btn-primary btn-lg btn-block">Carta de liberacion</button></a>
</div>
...
<fieldset class="fields2">
     ...
     <div class="input-group ">
      ...
      <button type="submit" class="btn btn-success pull-right">Enviar</button>
            ...
            <div role="tabpanel" class="tab-pane" id="egresadoLic">
...
<br><br>
  ...
  <div class="contenedor-modal">
 <a href="" data-target="#miModal40" data-toggle="modal"><button type="button" class="btn btn-primary btn-lg btn-block">Carta de presentacion 2</button></a>
</div>
...
<br><br>
  ...
  <div class="contenedor-modal">
 <a href="" data-target="#miModal40" data-toggle="modal"><button type="button" class="btn btn-primary btn-lg btn-block">Carta de aceptacion 2</button></a>
</div>
...
<br><br>
  ...
  <div class="contenedor-modal">
 <a href="" data-target="#miModal40" data-toggle="modal"><button type="button" class="btn btn-primary btn-lg btn-block">Carta compromiso 2</button></a>
</div>
...
<br><br>
  ...
  <div class="contenedor-modal">
 <a href="" data-target="#miModal40" data-toggle="modal"><button type="button" class="btn btn-primary btn-lg btn-block">Carta de liberacion 2</button></a>
</div>
...
<fieldset class="fields2">
     ...
     <div class="input-group ">
      ...
      <button type="submit" class="btn btn-success pull-right">Enviar</button>
                ...
                <!--Ricardo//////////////////////////////////////////-->
                    ...
                    <div role="tabpanel" class="tab-pane" id="onceCuatri">
  ...
  <div class="row">
      ...
      <div class="contenedor-modal">
 <a href="" data-target="#miModal38" data-toggle="modal"><button type="button" class="btn btn-primary btn-lg btn-block">Inscripción 11</button></a>
</div>
...
<br><br>
  ...
  <div class="contenedor-modal">
 <a href="" data-target="#miModal39" data-toggle="modal"><button type="button" class="btn btn-primary btn-lg btn-block">Pago 11</button></a>
</div>
...
<br><br>
  ...
  <div class="contenedor-modal">
 <a href="" data-target="#miModal40" data-toggle="modal"><button type="button" class="btn btn-primary btn-lg btn-block">Boleta 11</button></a>
</div>
...
<br><br>
  ...
  <div class="contenedor-modal">
 <a href="" data-target="#miModal40" data-toggle="modal"><button type="button" class="btn btn-primary btn-lg btn-block">Carta de presentacion 3</button></a>
</div>
...
<br><br>
  ...
  <div class="contenedor-modal">
 <a href="" data-target="#miModal40" data-toggle="modal"><button type="button" class="btn btn-primary btn-lg btn-block">Carta de aceptacion 3</button></a>
</div>
...
<br><br>
  ...
  <div class="contenedor-modal">
 <a href="" data-target="#miModal40" data-toggle="modal"><button type="button" class="btn btn-primary btn-lg btn-block">Carta compromiso 3</button></a>
</div>
...
<br><br>
  ...
  <div class="contenedor-modal">
 <a href="" data-target="#miModal40" data-toggle="modal"><button type="button" class="btn btn-primary btn-lg btn-block">Carta de liberacion 3</button></a>
</div>
...
<!--Ricardo/////////////////////////////////////////////////////////-->
                ...
                <!--Ricardo//////////////////////////////////////////-->
                <!--Este codigo muestra en todos los apartados los documntos entregados-->
      <div role="tabpanel" class="" id="entregados">
      <!--Este codigo muestra los documentos en el apartado de DOCUMENTOS-->
   ...
   <?php   foreach ($documentos as $documento): ?>
    ...
    <a href="{{url ('/')}} /storage/{{$documento['nombre']}}" target="_blank"> <?= $documento['descripcion']?></a> 
       ...
       <a href="" data-target="#modal-editdocumento-{{$documento['id']}}" data-toggle="modal"><button type="button" class="btn btn-primary btn-sm">Editar</button></a>
         <!--label><input type="checkbox" value="campo" name="option1"/>campo</label--> 
