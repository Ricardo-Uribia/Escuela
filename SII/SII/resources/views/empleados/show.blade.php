            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('empleados' . '/' . $empleados->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> IdEmpleado </th><td> {{ $empleado->idEmpleado }} </td></tr><tr><th> Paterno </th><td> {{ $empleado->txtPaterno }} </td></tr><tr><th> Materno </th><td> {{ $empleado->txtMaterno }} </td></tr>
                                </tbody>
                            </table>
                        </div>
