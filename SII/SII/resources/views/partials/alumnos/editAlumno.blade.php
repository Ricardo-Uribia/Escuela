            ...
            <center>
               ...
               <br>
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control" name="nivel" value="">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control" name="carreraAlumn" value="">
                    ...
                    <div class="input-group">
                        ...
                        <input type="date" class="form-control" placeholder="" name="fechaAct" value="{{$alum->Fecha_Actualizacion}}">
                    </div><br>
             ...
             <div role="tabpanel" class="tab-pane" id="datos">
               ...
               <br>
                    ...
                    <div class="input-group">
                        ...
                        <input name="estadoNacAlumn" class="form-control" value="{{$alum->Estado_Nac}}">
            ...
            <div role="tabpanel" class="tab-pane" id="domicilio">
               ...
               <br>
                    ...
                    <div class="input-group">
                        ...
                        <input name="estadoAlumno" class="form-control" value="{{$alum->Estado}}">
                    ...
                    <div class="input-group">
                     ...
                     <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="" name="personaAutoAlumn" value="{{$alum->Persona_Autorizada}}">
                    </div><br>
                    ...
                    <div class="input-group">
                        <span class="input-group-addon">Teléfono</span>
                        <input type="text" class="form-control" placeholder="" name="telAuto" value="{{$alum->Telefono_Autorizada}}">
                    </div><br>
...
<div role="tabpanel" class="tab-pane" id="escuela">
               ...
               <br>
                ...
                <div class="input-group">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon">Estado</span>
                        <input type="text" class="form-control" name="estadoEsc" value="{{$alum->Estado_Bachillerato}}">
                    </div><br>
                    ...
                    <div class="input-group">
                       ...
                       <div class="input-group">
                        ...
                        <input type="" class="form-control" placeholder="" name="tipoBach" value="{{$alum->Tipo_Bachillerato}}">
                        <span class="input-group-addon">Sistema</span>
                        <input type="" class="form-control" placeholder="" name="sisBach" value="{{$alum->Sistema_Bachillerato}}">
                    </div><br>
                        ...
                        <div id="sidebar">
                           ...
                           <div class="input-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="" name="disc" value="{{$alum->Discapacidad}}">
                            </div><br>
                            ...
                            <div class="input-group">
                             ...
                             <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="" name="talla" value="{{$alum->Talla}}">
                            </div><br>
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-addon">Escolaridad de la madre</span>
                                 <input name="escMad" class="form-control" value="{{$alum->Escolaridad_Madre}}">
                                    
                            </div><br>

                             <div class="input-group">
                                <span class="input-group-addon">Actividad del padre</span>
                               <input name="actPad" class="form-control" value="{{$alum->Actividad_Padre}}">
                                    
                            </div><br>

                            <div class="input-group">
                                <span class="input-group-addon">Actividad de la madre</span>
                                <input name="actMad" class="form-control" value="{{$alum->Actividad_Madre}}">
                             ...
                             <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="" name="segMed" value="{{$alum->Tipo_Seg_Med}}">
                            </div><br>
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="" name="casa" value="{{$alum->Tamano_Casa}}">
                            </div><br>
                            ...
                            <div class="input-group">
                             ...
                             <div class="input-group">
                                ...
                                <input name="actTrabajas" class="form-control" value="{{$alum->Act_Trabajas}}">
                             ...
                             <div class="input-group">
                              ...
                              <div class="input-group">
                                <span class="input-group-addon">Escolaridad del conyugue</span>
                                  <input name="escCon" class="form-control" value="{{$alum->Escolaridad_Conyuge}}">
                                    
                            </div><br>

                             <div class="input-group">
                                <span class="input-group-addon">Actividad del cónyuge</span>
                                <input name="actCon" class="form-control" value="{{$alum->Actividad_Conyuge}}">
