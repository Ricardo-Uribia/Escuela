    ...
    <div class="was-validated">
        <div class="form-group {{ $errors->has('matricula') ? 'has-error' : ''}}">
            <label for="matricula" class=" col-xs-8">Matricula :</label>
                <input name="matricula" type="number" class="form-control" id="matricula" value="{{ $alumnos->Matricula or ''}}">
...
<div class="col-md-4">
    <div class="was-validated">
        <div class="form-group {{ $errors->has('idCiclo') ? 'has-error' : ''}}">
            <label for="idCiclo" class=" col-xs-8">Id Ciclo :</label>
                <input name="idCiclo" type="text" class="form-control" id="idCiclo" value="{{ $grupos->id_Ciclo or ''}}">
        {!!$errors->first('id_Ciclo', '<p class="help-block"></p>')!!}
        </div>
    </div>
</div>
    ...
    <div class="was-validated">
        <div class="form-group {{ $errors->has('nombre') ? 'has-error' : ''}}">
            <label for="nombre" class=" col-xs-8">Nombre :</label>
                <input name="nombre" type="text" class="form-control" id="nombre" value="{{ $alumnos->Nombres or ''}}">
...
<div class="col-md-9">
    <div class="was-validated">
        <div class="form-group {{ $errors->has('id') ? 'has-error' : ''}}">
            <label for="id" class=" col-xs-8">Id Carrera :</label>
                <input name="id" type="text" class="form-control" id="id" value="{{ $grupos->id_Carrera or ''}}">
                {!! $errors->first('id_Carrera', '<p class="help-block">:message</p>') !!}
        </div>
    </div>
</div>
...
<!--div class="col-md-4">
    <div class="was-validated">
        <div class="form-group {{ $errors->has('trabajas_actual') ? 'has-error' : ''}}">
        <label for="trabajas_actual" class="col-xs-8"></label>
            <select class="form-control" name="trabajas_actual">
                <option value="SI">SI</option>
                <option value="NO">NO</option>
            {!! $errors->first('trabajas_actual', '<p class="help-block">:message</p>')!!}
