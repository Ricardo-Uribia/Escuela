...
<div class="form-group {{ $errors->has('idCiclo') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <input class="form-control" name="idCiclo" type="number" id="idCiclo" value="{{ $alumnos_villa->idCiclo or ''}}" readonly>
...
<div class="form-group {{ $errors->has('idcatalogo_villas') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <input class="form-control" name="idcatalogo_villas" type="number" id="idcatalogo_villas" value="{{ $alumnos_villa->idcatalogo_villas or ''}}" readonly>
...
<div class="form-group {{ $errors->has('idalumno') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <input class="form-control" name="idalumno" type="number" id="idalumno" value="{{ $alumnos_villa->idalumno or ''}}" readonly>
...
<div class="form-group {{ $errors->has('idgrupo') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <input class="form-control" name="idgrupo" type="number" id="idgrupo" value="{{ $alumnos_villa->idgrupo or ''}}" readonly>
